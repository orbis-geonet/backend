...
export const notifyingCompleted = (notificationPath: string) => {
  logger.log("Writing to RTDB at key " + notificationPath)
}

export const notifiedCompleted = (notificationPath: string) => {
  logger.log("Written to RTDB at key " + notificationPath)
}
